...
public class LoginActivity extends AbstractBaseActivity implements LoaderCallbacks<Cursor> {
    ...
    public static void startAction(Context ctx){
        Tools.toActivity(ctx,LoginActivity.class);
    }
    @Override
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(mEmail.equals("123456") && mPassword.equals("123456") ){
                CommonFunction.putBoolean(AppConfig.ISFIRST,true);
                return true;
            }else if(mEmail.equals("654321") && mPassword.equals("654321")){
                CommonFunction.putBoolean(AppConfig.ISFIRST,false);
                return true;
            }else {
                return false;
            }
