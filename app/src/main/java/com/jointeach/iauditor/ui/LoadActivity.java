...
public class LoadActivity extends AbstractBaseActivity {
    ...
    ,"2.3-是否标识灭火器地点和灭火器种类？","2.4-近期是否有维护灭火器？（每六个月检查一次）"
            ,"2.5-灭火器是否被阻挡？","2.6-灭火器放置不超过1200毫米且不低于100毫米？"
            ,"2.7-指示标志是否在地面2.1米以上？","2.8-是否有明显的消防指示标示？","2.9-安全出口门是否可以从内容轻易开启？"
            ,"2.10-安全出口是否被堵塞？","2.11-报警系统是否正常运行？"}
            ,{"3.1-良好的自然采光?","3.2-墙壁和天花板反射光不会影响员工视觉?","3.3-灯具干净且状态良好","3.4安全出口灯正常?"}
            ,{"4.1-地面平坦、清洁?","4.2-进出通道保持清洁?","4.3-通道是否有足够、合适且清楚的标识？"
            ,"4.4-通道交叉口是否有放置杂物？","4.5-楼梯和升降装置是否保持清洁?","4.6-液体泄漏物是否被很快处置？"
            ,"4.7-围栏、栏杆状态良好？","4.8-在有缝隙、缺口等地方是否做好安全防护？","4.9-人行道是否处于良好状态？"
            ,"4.10-家具状态是否良好？","4.11-装卸区域是否干净整洁？"}
            ,{"5.1-垃圾是否清理？","5.2-不使用工具是否放置正确？","5.3-是否使用已损坏的手持工具？"
            ,"5.4-是否使用已损坏的电动工具？","5.5-工作高度是否与工作类型和员工相匹配？","5.6-是有有锋利边缘？"}
            ,{"6.1-垃圾箱是否放置在合适的位置？","6.2-垃圾箱是否定期清理？","6.3-是否使用金属容器盛装含有抹布与易燃废物？"}
            ,{"7.1-原料是否存在合适的货架或箱子中？","7.2-储存设计是否解决了最大程度降低最小起重重量的问题？"
            ,"7.3-货架周围是否存有垃圾？","7.4-货架和托盘状态是否良好？"}
            ,{"8.1-是否保持干挣？","8.2-设备周围地面是否保持干净？","8.3-防护装置是否处于良好状态？"
            ,"8.4-启动、停止装置是处在操作人员容易操作的范围内？","8.5-废弃的切割物品是否隔离且安全存放？"
            ,"8.6-是否有防泄漏装置放置泄漏物扩散？","8.7-是否有适当的工作空间？","8.8-是否有适当的工作空间？"
            ,"8.9-噪声是否处于合适范围？","8.10-是否需要弯腰或身体弯曲进行工作？","8.11-是否需要弯腰或身体弯曲进行工作？"
