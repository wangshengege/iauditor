package org.mylibrary.view.wheelview;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xF0303030;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFFcecece;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFf8f9fa,
			0xb9f8f9fa, 0xb9f8f9fa };
	...
	/**
	 * Builds text depending on current value 生成item用\n隔开，就形成换行
	 * 
	...
	private void drawShadows(Canvas canvas) {
		topShadow.setBounds(0, 0, getWidth(), (getHeight() / visibleItems) * 3);
