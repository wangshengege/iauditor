 ...
 * @date 2013-10-08
 */
public class XHeaderViewPour extends LinearLayout {
	...
	public XHeaderViewPour(Context context) {
		super(context);
		initView(context);
	}

	public XHeaderViewPour(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
