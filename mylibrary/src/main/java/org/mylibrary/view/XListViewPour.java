...
/**
 * 倒着的（主要用于对话聊天形式）：XListView, it's based on <a
 * href="https://github.com/Maxwin-z/XListView-Android">XListView(Maxwin)</a>
 * 
 * @author markmjw
 * @date 2013-10-08
 */
public class XListViewPour extends ListView implements OnScrollListener {
	...
	private XHeaderViewPour mHeader;
	...
	public XListViewPour(Context context) {
		super(context);
		initWithContext(context);
	}

	public XListViewPour(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public XListViewPour(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initWithContext(context);
	}

	private void initWithContext(Context context) {
		this.setDivider(null);// 去除横线

		mScroller = new Scroller(context, new DecelerateInterpolator());
		super.setOnScrollListener(this);

		// init header view
		mHeader = new XHeaderViewPour(context);
