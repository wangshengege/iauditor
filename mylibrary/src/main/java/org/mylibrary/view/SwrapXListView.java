 ...
 * 
 * @author markmjw
 * @date 2013-10-08 在Xlistview的基础上增加侧滑删除功能
 */
public class SwrapXListView extends ListView implements OnScrollListener {
	 ...
	 * @param context
	 */
	public SwrapXListView(Context context) {
		super(context);
		initWithContext(context);
	}

	public SwrapXListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public SwrapXListView(Context context, AttributeSet attrs, int defStyle) {
