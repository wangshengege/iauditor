package org.mylibrary.view.swipe.implments;
...
import org.mylibrary.view.swipe.SimpleSwipeListener;
import org.mylibrary.view.swipe.SwipeLayout;
import org.mylibrary.view.swipe.interfaces.SwipeAdapterInterface;
import org.mylibrary.view.swipe.interfaces.SwipeItemMangerInterface;
...
public class SwipeItemMangerImpl implements SwipeItemMangerInterface {
	...
	public SwipeItemMangerImpl(BaseAdapter adapter){
		...
		if (!(adapter instanceof SwipeItemMangerInterface))
			throw new ClassCastException("adapter should implement the SwipeAdapterInterface");
	...
	public void initialize(View torget, int position) {
		int resId = getSwipeLayoutId(position);

		OnLayoutListener onLayoutListener = new OnLayoutListener(position);
		SwipeLayout swipeLayout = (SwipeLayout) torget.findViewById(resId);
		if (swipeLayout == null)
			throw new IllegalStateException(
					"can not find SwipeLayout in torget view");
	...
	public void updateConvertView(View torget, int position) {
		int resId = getSwipeLayoutId(position);
